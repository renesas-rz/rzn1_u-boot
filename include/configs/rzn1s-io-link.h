...
#ifndef __RZN1S_IO_LINK_H
#define __RZN1S_IO_LINK_H

#include "rzn1-common.h"
#include "renesas/rzn1-memory-map.h"
#include "renesas/rzn1-sysctrl.h"

#define CONFIG_BOARD_NAME	"Renesas RZN1S IO-Link"
...
/*
 * GMAC1 is connected to a Marvell PHY
 ...
 * Two Micrel PHYs are on the CPU board. The board setup code specifies the MII
 * interface type used, see call to designware_initialize_fixed_link().
