...
#define CONFIG_BOOTCOMMAND	\
	"cp.l 0x00200000 0x08007fc0 0x100000; bootm 0x08007fc0"
#define CONFIG_ZERO_BOOTDELAY_CHECK

/* high level configuration options */
#define	CONFIG_ARMV7	1
#define	CONFIG_SILVERSTONE
