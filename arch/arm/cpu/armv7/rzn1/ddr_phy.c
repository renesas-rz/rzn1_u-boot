...
void ddr_phy_init(int ddr_type)
{
	...
	rzn1_clk_set_gate(RZN1_ACLK_AXIY_ID, 0);
	rzn1_clk_set_gate(RZN1_CLK_DDR_ID, 0);

	rzn1_clk_reset_state(RZN1_ACLK_AXIY_ID, 0);
	rzn1_clk_reset_state(RZN1_CLK_DDR_ID, 0);
	...
	rzn1_clk_reset_state(RZN1_CLK_DDR_ID, 1);
	rzn1_clk_reset_state(RZN1_ACLK_AXIY_ID, 1);
